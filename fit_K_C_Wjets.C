...
void fit_K_C_Wjets()
{
  ...
  char TH2Name[100];
  sprintf(fileName,"ROOT_SVG/Wjets_checkCorrection.root");
  if (nocorr)
  {
    sprintf(SaveFileName,"ROOT_SVG/K_C_fit_Wjets/K_C_fit_C_file_nocorr.txt");
    sprintf(SaveFileROOT,"ROOT_SVG/K_C_fit_Wjets/K_C_fit_C_file_nocorr.root");
    sprintf(TH2Name,"Ih_VS_p_SatNoCorr");
  }
  if (oldcorr)
  {
    sprintf(SaveFileName,"ROOT_SVG/K_C_fit_Wjets/K_C_fit_C_file_oldcorr.txt");
    sprintf(SaveFileROOT,"ROOT_SVG/K_C_fit_Wjets/K_C_fit_C_file_oldcorr.root");
    sprintf(TH2Name,"Ih_VS_p_OldCorr");
  }
  if (newcorr)
  {
    sprintf(SaveFileName,"ROOT_SVG/K_C_fit_Wjets/K_C_fit_C_file_newcorr.txt");
    sprintf(SaveFileROOT,"ROOT_SVG/K_C_fit_Wjets/K_C_fit_C_file_newcorr.root");
    sprintf(TH2Name,"Ih_VS_p_SatCorr");
  }
  ...
  TH2F *dEdX0stripVsP_lowp = (TH2F*)file->Get(TH2Name);
