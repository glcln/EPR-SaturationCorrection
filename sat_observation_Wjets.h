...
#ifndef sat_observation_Wjets_h
#define sat_observation_Wjets_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   sat_observation_Wjets(TTree *tree=0);
   virtual ~sat_observation_Wjets();
...
#ifdef sat_observation_Wjets_cxx
sat_observation_Wjets::sat_observation_Wjets(TTree *tree) : fChain(0)
{
...
sat_observation_Wjets::~sat_observation_Wjets()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t sat_observation_Wjets::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t sat_observation_Wjets::LoadTree(Long64_t entry)
{
...
void sat_observation_Wjets::Init(TTree *tree)
{
...
Bool_t sat_observation_Wjets::Notify()
{
...
void sat_observation_Wjets::Show(Long64_t entry)
{
...
Int_t sat_observation_Wjets::Cut(Long64_t entry)
{
...
#endif // #ifdef sat_observation_Wjets_cxx
