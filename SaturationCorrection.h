...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   SaturationCorrection(TTree *tree=0);
   virtual ~SaturationCorrection();
...
#ifdef SaturationCorrection_cxx
SaturationCorrection::SaturationCorrection(TTree *tree) : fChain(0) 
{
...
Int_t SaturationCorrection::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t SaturationCorrection::LoadTree(Long64_t entry)
{
...
void SaturationCorrection::Init(TTree *tree)
{
...
Bool_t SaturationCorrection::Notify()
{
...
void SaturationCorrection::Show(Long64_t entry)
{
...
Int_t SaturationCorrection::Cut(Long64_t entry)
{
...
#endif // #ifdef SaturationCorrection_cxx
