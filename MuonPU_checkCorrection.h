...
#ifndef MuonPU_checkCorrection_h
#define MuonPU_checkCorrection_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         sclus_loctheta[nmax_cl];   //[ndedxhits]
   ...
   MuonPU_checkCorrection(TTree *tree=0);
   virtual ~MuonPU_checkCorrection();
...
#ifdef MuonPU_checkCorrection_cxx
MuonPU_checkCorrection::MuonPU_checkCorrection(TTree *tree) : fChain(0) 
{
...
MuonPU_checkCorrection::~MuonPU_checkCorrection()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MuonPU_checkCorrection::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MuonPU_checkCorrection::LoadTree(Long64_t entry)
{
...
void MuonPU_checkCorrection::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("sclus_loctheta", sclus_loctheta, &b_sclus_loctheta);
...
Bool_t MuonPU_checkCorrection::Notify()
{
...
void MuonPU_checkCorrection::Show(Long64_t entry)
{
...
Int_t MuonPU_checkCorrection::Cut(Long64_t entry)
{
...
#endif // #ifdef MuonPU_checkCorrection_cxx
