...
beta = np.arange(0.1, 1, pow(10,-power_exp))
beta_gamma = []
gamma = []
Tmax = []
delta = []
...
if (InfunctionOf_p == False):
    ...
    plt.plot(beta_gamma, dedx, color='blue', label=r'$\textrm{proton on Si}$')
    ...
    plt.savefig("bethebloch_betagamma.pdf")
else:
