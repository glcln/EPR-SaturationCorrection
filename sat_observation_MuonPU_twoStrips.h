...
#ifndef sat_observation_MuonPU_twoStrips_h
#define sat_observation_MuonPU_twoStrips_h
...
class sat_observation_MuonPU_twoStrips {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   sat_observation_MuonPU_twoStrips(TTree *tree=0);
   virtual ~sat_observation_MuonPU_twoStrips();
...
#ifdef sat_observation_MuonPU_twoStrips_cxx
sat_observation_MuonPU_twoStrips::sat_observation_MuonPU_twoStrips(TTree *tree) : fChain(0)
{
...
sat_observation_MuonPU_twoStrips::~sat_observation_MuonPU_twoStrips()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t sat_observation_MuonPU_twoStrips::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t sat_observation_MuonPU_twoStrips::LoadTree(Long64_t entry)
{
...
void sat_observation_MuonPU_twoStrips::Init(TTree *tree)
{
...
Bool_t sat_observation_MuonPU_twoStrips::Notify()
{
...
void sat_observation_MuonPU_twoStrips::Show(Long64_t entry)
{
...
Int_t sat_observation_MuonPU_twoStrips::Cut(Long64_t entry)
{
...
#endif // #ifdef sat_observation_MuonPU_twoStrips_cxx
