...
#ifndef sat_observation_MuonPU_h
#define sat_observation_MuonPU_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   sat_observation_MuonPU(TTree *tree=0);
   virtual ~sat_observation_MuonPU();
...
#ifdef sat_observation_MuonPU_cxx
sat_observation_MuonPU::sat_observation_MuonPU(TTree *tree) : fChain(0)
{
...
sat_observation_MuonPU::~sat_observation_MuonPU()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t sat_observation_MuonPU::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t sat_observation_MuonPU::LoadTree(Long64_t entry)
{
...
void sat_observation_MuonPU::Init(TTree *tree)
{
...
Bool_t sat_observation_MuonPU::Notify()
{
...
void sat_observation_MuonPU::Show(Long64_t entry)
{
...
Int_t sat_observation_MuonPU::Cut(Long64_t entry)
{
...
#endif // #ifdef sat_observation_MuonPU_cxx
