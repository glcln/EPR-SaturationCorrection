...
#ifndef Wjets_checkCorrection_h
#define Wjets_checkCorrection_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Wjets_checkCorrection(TTree *tree=0);
   virtual ~Wjets_checkCorrection();
...
#ifdef Wjets_checkCorrection_cxx
Wjets_checkCorrection::Wjets_checkCorrection(TTree *tree) : fChain(0)
{
...
Wjets_checkCorrection::~Wjets_checkCorrection()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Wjets_checkCorrection::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Wjets_checkCorrection::LoadTree(Long64_t entry)
{
...
void Wjets_checkCorrection::Init(TTree *tree)
{
...
Bool_t Wjets_checkCorrection::Notify()
{
...
void Wjets_checkCorrection::Show(Long64_t entry)
{
...
Int_t Wjets_checkCorrection::Cut(Long64_t entry)
{
...
#endif // #ifdef Wjets_checkCorrection_cxx
