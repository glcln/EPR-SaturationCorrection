...
// Thu Aug  8 14:39:37 2024 by ROOT version 6.14/09
// from TTree ttree/ttree
// found on file: /opt/sbg/cms/ui3_data1/ccollard/HSCP_prod/prodFeb2022_CMSSW_10_6_27_probq/SingleMuon/UL2018_RunD/220201_164157/0000/nt_aod_ul2018_99.root
//////////////////////////////////////////////////////////

#ifndef CorrectionOnData_h
#define CorrectionOnData_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   CorrectionOnData(TTree *tree=0);
   virtual ~CorrectionOnData();
...
#ifdef CorrectionOnData_cxx
CorrectionOnData::CorrectionOnData(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/opt/sbg/cms/ui3_data1/ccollard/HSCP_prod/prodFeb2022_CMSSW_10_6_27_probq/SingleMuon/UL2018_RunD/220201_164157/0000/nt_aod_ul2018_99.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/opt/sbg/cms/ui3_data1/ccollard/HSCP_prod/prodFeb2022_CMSSW_10_6_27_probq/SingleMuon/UL2018_RunD/220201_164157/0000/nt_aod_ul2018_99.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/opt/sbg/cms/ui3_data1/ccollard/HSCP_prod/prodFeb2022_CMSSW_10_6_27_probq/SingleMuon/UL2018_RunD/220201_164157/0000/nt_aod_ul2018_99.root:/stage");
...
CorrectionOnData::~CorrectionOnData()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t CorrectionOnData::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t CorrectionOnData::LoadTree(Long64_t entry)
{
...
void CorrectionOnData::Init(TTree *tree)
{
...
Bool_t CorrectionOnData::Notify()
{
...
void CorrectionOnData::Show(Long64_t entry)
{
...
Int_t CorrectionOnData::Cut(Long64_t entry)
{
...
#endif // #ifdef CorrectionOnData_cxx
